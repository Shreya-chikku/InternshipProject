...
<html lang="en">
    <head>
        ...
        <title>Printing Press | Add Category</title>
...
<strong>Category Successfully Added!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<strong>Sorry, an error has occured!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
