...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Printing Press | Add Post</title>
...
<strong>Hurray! a new post added successfully</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<strong>Ohhhh! an error has occured</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
